...
val _ = new_theory "function_register_write_properties_lemmas";

Theorem FUNCTION_REGISTER_WRITE_IMPLIES_PENDING_ACCESSES_RESTRICTED_LEMMA:
!R W memory device_characteristics device1 device2 address_bytes.
...
ITAC device_register_write_lemmasTheory.FUNCTION_REGISTER_WRITE_PRESERVES_ALL_DMA_CHANNEL_PENDING_ACCESSES_LEMMA THEN
STAC
QED

Theorem FUNCTION_REGISTER_WRITE_PRESERVES_REGISTER_REQUESTING_READ_ADDRESSES_LEMMA:
...
Proof
INTRO_TAC THEN
ITAC device_register_write_lemmasTheory.FUNCTION_REGISTER_WRITE_PRESERVES_PENDING_REGISTER_RELATED_MEMORY_REQUESTS_LEMMA THEN
...
Theorem FUNCTION_REGISTER_WRITE_PRESERVES_REGISTER_REQUESTING_WRITE_ADDRESSES_LEMMA:
!device_characteristics device1 device2 memory address_bytes.
  device2 = function_register_write device_characteristics device1 address_bytes /\
...
Theorem FUNCTION_REGISTER_WRITE_PRESERVES_DEVICE_REQUESTING_READ_ADDRESSES_LEMMA:
...
[
 ...
 INTRO_TAC THEN
 AIRTAC THEN
 IRTAC FUNCTION_REGISTER_WRITE_IMPLIES_PENDING_ACCESSES_RESTRICTED_LEMMA THEN
 IRTAC read_properties_lemmasTheory.PENDING_ACCESSES_RESTRICTED_PRESERVES_CHANNEL_R_LEMMA THEN
 STAC
 ,
 ITAC FUNCTION_REGISTER_WRITE_PRESERVES_REGISTER_REQUESTING_READ_ADDRESSES_LEMMA THEN
 STAC
]
QED

Theorem FUNCTION_REGISTER_WRITE_PRESERVES_DEVICE_REQUESTING_WRITE_ADDRESSES_LEMMA:
!memory device_characteristics device1 device2 address_bytes.
  device2 = function_register_write device_characteristics device1 address_bytes /\
...
[
 ...
 STAC
 ,
 ITAC FUNCTION_REGISTER_WRITE_PRESERVES_REGISTER_REQUESTING_WRITE_ADDRESSES_LEMMA THEN
 STAC
]
QED

Theorem FUNCTION_REGISTER_WRITE_PRESERVES_DEVICE_REQUESTING_READ_WRITE_ADDRESSES_LEMMA:
!memory device_characteristics device1 device2 address_bytes.
  device2 = function_register_write device_characteristics device1 address_bytes /\
  DEVICE_REQUESTING_READ_ADDRESSES device_characteristics memory device1 /\
  DEVICE_REQUESTING_WRITE_ADDRESSES device_characteristics memory device1
...
Proof
INTRO_TAC THEN
ITAC FUNCTION_REGISTER_WRITE_PRESERVES_DEVICE_REQUESTING_READ_ADDRESSES_LEMMA THEN
ITAC FUNCTION_REGISTER_WRITE_PRESERVES_DEVICE_REQUESTING_WRITE_ADDRESSES_LEMMA THEN
STAC
QED
