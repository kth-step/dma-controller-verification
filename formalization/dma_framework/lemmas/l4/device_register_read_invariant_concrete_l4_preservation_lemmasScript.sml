...
val _ = new_theory "device_register_read_invariant_concrete_l4_preservation_lemmas";

Theorem FUNCTION_REGISTER_READ_L4_IMPLIES_BDS_TO_FETCH_NOT_EXPANDED_LEMMA:
!device_characteristics memory1 memory2 cpu_address_bytes device1 device2 dma_address_bytes.
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = function_register_read device_characteristics device1 (MAP FST cpu_address_bytes) /\
  memory2 = update_memory memory1 dma_address_bytes
  ==>
  BDS_TO_FETCH_NOT_EXPANDED device_characteristics memory1 memory2 device1.dma_state.internal_state device2.dma_state.internal_state
Proof
INTRO_TAC THEN
...
Theorem FUNCTION_REGISTER_READ_L4_IMPLIES_CHANNELS_EQ_LEMMA:
!device_characteristics cpu_address_bytes device1 device2 dma_address_bytes.
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = function_register_read device_characteristics device1 (MAP FST cpu_address_bytes)
  ==>
...
Theorem FUNCTION_REGISTER_READ_L4_IMPLIES_BD_TRANSFER_RAS_WAS_EQ_LEMMA:
!device_characteristics cpu_address_bytes device1 device2 dma_address_bytes.
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = function_register_read device_characteristics device1 (MAP FST cpu_address_bytes)
  ==>
...
Theorem DMA_REGISTER_READ_L4_PRESERVES_INVARIANT_CONCRETE_L4_LEMMA:
!(device_characteristics : ('bd_type, 'channel_index_width, 'environment_type, 'function_state_type, 'interconnect_address_width, 'internal_state_type, 'tag_width) device_characteristics_type)
 ...
 INVARIANT_CPU cpu_transition  cpu1 cpu2 memory1 memory2 cpu_address_bytes dma_address_bytes.
  ...
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = dma_register_read device_characteristics is_valid_l4 device1 (MAP FST cpu_address_bytes) /\
  memory2 = update_memory memory1 dma_address_bytes /\
...
RLTAC THEN
PTAC proof_obligations_cpu_l4Theory.PROOF_OBLIGATION_CPU_REGISTER_READ_MEMORY_WRITE_PRESERVES_INVARIANT_CONCRETE_L4 THEN
AIRTAC THEN
STAC
QED
...
Theorem FUNCTION_REGISTER_READ_PRESERVES_INVARIANT_CONCRETE_L4_LEMMA:
!device_characteristics memory1 memory2 device1 device2 dma_address_bytes cpu_address_bytes.
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = function_register_read device_characteristics device1 (MAP FST cpu_address_bytes) /\
  memory2 = update_memory memory1 dma_address_bytes /\
  INVARIANT_CONCRETE_L4 device_characteristics memory1 device1
  ==>
...
Proof
INTRO_TAC THEN
ITAC FUNCTION_REGISTER_READ_L4_IMPLIES_BDS_TO_FETCH_NOT_EXPANDED_LEMMA THEN
ITAC FUNCTION_REGISTER_READ_L4_IMPLIES_BD_TRANSFER_RAS_WAS_EQ_LEMMA THEN
ITAC FUNCTION_REGISTER_READ_L4_IMPLIES_CHANNELS_EQ_LEMMA THEN
ITAC FUNCTION_REGISTER_READ_PRESERVES_MEMORY_LEMMA THEN
RLTAC THEN
...
Theorem DEVICE_REGISTER_READ_L4_PRESERVES_INVARIANT_CONCRETE_L4_LEMMA:
!INVARIANT_CPU cpu_transition device_characteristics cpu1 cpu2 memory1 memory2 cpu_address_bytes dma_address_bytes device1 device2.
  ...
  INVARIANT_CPU memory1 cpu1 /\
  cpu_transition cpu1 (cpu_memory_read cpu_address_bytes) cpu2 /\
  (device2, dma_address_bytes, MAP SND cpu_address_bytes) = device_register_read_l4 device_characteristics device1 (MAP FST cpu_address_bytes) /\
  memory2 = update_memory memory1 dma_address_bytes /\
  INVARIANT_CONCRETE_L4 device_characteristics memory1 device1
  ==>
  INVARIANT_CONCRETE_L4 device_characteristics memory2 device2
Proof
INTRO_TAC THEN
PTAC l4Theory.device_register_read_l4 THEN
PTAC operationsTheory.device_register_read THENL
[
 IRTAC DMA_REGISTER_READ_L4_PRESERVES_INVARIANT_CONCRETE_L4_LEMMA THEN STAC
 ,
 IRTAC FUNCTION_REGISTER_READ_PRESERVES_INVARIANT_CONCRETE_L4_LEMMA THEN STAC
 ,
